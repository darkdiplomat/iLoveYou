...
public class WheelSpinner<E>{
    ...
    public void add(E what, double weight, int level){
        if (this.wheel.containsKey(Integer.valueOf(level))){
            ((ArrayList) this.wheel.get(Integer.valueOf(level))).add(new WheelSpinner.Weight(what, weight));
        }
        else {
            ArrayList newList = new ArrayList();
            newList.add(new WheelSpinner.Weight(what, weight));
    ...
    private class Weight{
        ...
        public Weight(E data, double weight){
