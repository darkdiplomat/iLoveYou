...
public class iLoveYou extends Plugin{
    ...
    public static boolean blockIsAboveAir(World world, double x, double y, double z){
        return world.getBlockAt((int) Math.floor(x), (int) Math.floor(y - 1.0D), (int) Math.floor(z)).getType() == 0;
    }

    public static boolean blockIsSafe(World world, double x, double y, double z){
    ...
    public static boolean blockIsAvailable(World world, double x, double y, double z){
